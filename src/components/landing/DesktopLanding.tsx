      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-20 bg-white/70 backdrop-blur-[10px] border-b border-gray-200">
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Button 
              variant="secondary" 
              className="bg-gray-100 text-black font-bold hover:bg-gray-200 text-base px-4"
            >
              Sign up
            </Button>
          </nav>
          ...
          <div className="max-w-96 mx-auto relative">
            <div className="flex bg-white rounded-2xl shadow-[0px_2px_4px_0px_rgba(0,0,0,0.04)] shadow-[0px_0px_0px_1px_rgba(227,226,224,0.50)] overflow-hidden">
              <Input 
                type="email" 
                placeholder="Email" 
                className="flex-1 border-0 bg-transparent text-base font-medium placeholder:text-neutral-400 focus-visible:ring-0 focus-visible:ring-offset-0 p-4"
              />
              <Button className="bg-black text-white font-medium hover:bg-gray-800 rounded-md m-2 text-base">
                Sign up
              </Button>
            </div>
          </div>
