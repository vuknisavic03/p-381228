      ...
      <div className="flex-1 overflow-y-auto px-8 py-6">
        <div className="max-w-2xl space-y-6">
          ...
          <Card className="p-6 border border-gray-100 shadow-sm">
            ...
            <p className="text-sm text-gray-600 mb-6">Update the location details of your listing</p>
          ...
          <Card className="p-6 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-medium text-gray-900">Listing Type</h2>
            </div>
            <p className="text-sm text-gray-600 mb-6">Update the type and structure of your listing</p>
          ...
          {formData.type && (
            <Card className="p-6 border border-gray-100 shadow-sm">
              ...
              <p className="text-sm text-gray-600 mb-6">Configure the specific details of your listing</p>
          ...
          <Card className="p-6 border border-gray-100 shadow-sm">
            ...
            <p className="text-sm text-gray-600 mb-6">Update any additional information about this listing</p>
