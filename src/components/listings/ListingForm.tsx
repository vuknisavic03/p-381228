      ...
      <div className="flex-shrink-0 px-12 py-8 border-b border-gray-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-base text-gray-500 mt-2">Create a new property listing</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            {onClose && (
              <Button variant="ghost" size="sm" onClick={onClose} className="h-9 w-9 p-0 rounded-md hover:bg-gray-100">
                <X className="h-5 w-5" />
              </Button>
            )}
          </div>
                    ...
                    <SelectContent>
                      {propertyTypes.map((type) => (
                        <SelectItem key={type.value} value={type.value}>
                          <div className="flex items-center gap-3">
                            {React.cloneElement(getPropertyTypeIcon(type.value), { className: "h-5 w-5 text-gray-500" })}
