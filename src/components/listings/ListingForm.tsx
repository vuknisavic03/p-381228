...
export function ListingForm({ onClose, onListingAdded }: ListingFormProps) {
  ...
  return (
    <div className="h-full bg-white flex flex-col">
      {/* Header */}
      <div className="flex-shrink-0 px-10 py-8 border-b border-gray-100">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Add New Property</h1>
            <p className="text-gray-500 mt-2">Create a new property listing with all the details</p>
          </div>
          <div className="flex items-center gap-4">
            ...
            {onClose && (
              <Button variant="ghost" size="sm" onClick={onClose} className="h-10 w-10 p-0 rounded-xl hover:bg-gray-100">
                <X className="h-5 w-5" />
              </Button>
            )}
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8 pl-14">
              ...
              {!useUnitsMode && shouldShowOccupancyStatus() && (
                <div className="flex items-center justify-between p-6 bg-gray-50 rounded-2xl">
                  <div>
                    <h3 className="font-semibold text-gray-900">Occupancy Status</h3>
      ...
      {/* Action Buttons */}
      <div className="flex-shrink-0 px-10 py-8 border-t border-gray-100 bg-white">
        <div className="flex gap-4 max-w-4xl mx-auto">
          <Button 
            onClick={handleSave} 
            disabled={isProcessing || !isFormValid}
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white h-12 text-base font-medium rounded-xl"
          >
            {isProcessing ? (
              <div className="flex items-center gap-3">
          ...
          {onClose && (
            <Button 
              ...
              className="flex-1 bg-white border-gray-200 hover:bg-gray-50 h-12 text-base font-medium rounded-xl"
            >
              Cancel
            </Button>
          )}
