...
export function MapListingSelector({ listings, selectedListingId, onListingSelect, onClose }: MapListingSelectorProps) {
  ...
  console.log("MapListingSelector render - isLoaded:", isLoaded, "listings:", listings.length);
  ...
  }, [selectedListing, onListingSelect, onClose]);
    ...
    return (
      <div className="h-full w-full bg-gray-900 rounded-lg">
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <h3 className="text-lg font-semibold text-white">Select Property</h3>
          <Button
            onClick={onClose}
            variant="ghost"
            size="sm"
        ...
        <div className="flex flex-col h-[500px] items-center justify-center bg-gray-50 p-6">
  ...
  if (!isLoaded || isProcessing) {
    return (
      <div className="h-full w-full bg-gray-900 rounded-lg">
        ...
        <div className="flex flex-col h-[500px] items-center justify-center bg-gray-900">
  ...
  if (loadError) {
    ...
    return (
      <div className="h-full w-full bg-gray-900 rounded-lg">
        ...
        <div className="flex flex-col h-[500px] items-center justify-center bg-gray-900 p-6">
          ...
          {mapListings.map((listing, index) => (
            <MarkerF
              ...
              icon={{
                ...
                fillColor: listing.id === selectedListingId ? "#22c55e" : getMarkerColor(listing.type),
                fillOpacity: hoveredListing === listing.id ? 1 : 0.9,
                strokeWeight: listing.id === selectedListingId ? 4 : (hoveredListing === listing.id ? 3 : 2),
                strokeColor: listing.id === selectedListingId ? "#16a34a" : "#ffffff",
