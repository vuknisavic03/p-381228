...
const mockTransactions = [
  ...
  // General Portfolio Transactions (no selectedListingId)
  {
    id: 16,
  ...
  },
  {
    ...
    amount: 99,
    paymentMethod: "Credit Card",
    from: "PropertyManager Pro",
    notes: "Monthly subscription for property management software",
    selectedListingId: "",
  },
  {
    id: 20,
    ...
    notes: "Monthly business account maintenance fee",
    selectedListingId: "",
  },
  {
    id: 21,
    ...
    notes: "Quarterly dividend payment from REIT investments",
    selectedListingId: "",
  },
  {
    id: 22,
  ...
  },
  {
    ...
    amount: 320,
    paymentMethod: "Credit Card",
    from: "Business Travel Expenses",
    notes: "Travel expenses for property inspections",
    selectedListingId: "",
  },
  // More property-specific transactions
  {
    id: 24,
    ...
    amount: 1950,
    paymentMethod: "Bank Transfer",
    from: "Oak Street Duplex - Maria Rodriguez",
    notes: "Monthly rent payment for unit A",
    selectedListingId: "1",
  },
  {
    id: 25,
    ...
    amount: 425,
    paymentMethod: "Check",
    from: "Handyman Services LLC",
    notes: "Kitchen cabinet repair and painting",
    selectedListingId: "3",
  },
  {
    id: 26,
    ...
    amount: 2200,
    paymentMethod: "Bank Transfer",
    from: "Downtown Loft - Tech Startup",
    notes: "April commercial rent payment",
    selectedListingId: "2",
  },
  {
    id: 27,
    ...
    amount: 180,
    paymentMethod: "Credit Card",
    from: "SecureGuard Systems",
    notes: "Monthly security system monitoring",
    selectedListingId: "4",
  },
  {
    id: 28,
    ...
    amount: 50,
    paymentMethod: "Cash",
    from: "Mountain Cabin - Late Fee",
    notes: "Late payment penalty collected",
    selectedListingId: "5",
  }
];
