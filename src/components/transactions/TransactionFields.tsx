...
export function TransactionFields({ 
  ...
  return (
    <div className="space-y-6">
      {/* Property & Transaction Type Section */}
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-medium text-gray-800">Property & Transaction</h3>
        ...
        {fields.listingType === "listing" ? (
          <div className="bg-gray-50/50 border border-gray-100 rounded-lg p-5 space-y-4">
            ...
            <div>
              <div className="text-xs font-medium text-gray-500 mb-2">Property</div>
            ...
            {/* Unit Selection Row - only show if listing has multiple units */}
            {hasMultipleUnits && (
              <div>
                <div className="text-xs font-medium text-gray-500 mb-2">Unit</div>
                <UnitSelector
            ...
            {selectedListing && (
              <div className="pt-2 border-t border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-xs font-medium text-gray-500">Transaction Type</div>
          ...
          <div className="bg-purple-50/30 border border-purple-100 rounded-lg p-5">
            <div className="flex items-center justify-between mb-3">
              <div>
                <div className="text-sm text-purple-700 font-medium mb-1">General Transaction</div>
        ...
        <>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <h3 className="text-sm font-medium text-gray-800">Payment Details</h3>
            ...
            <div className="bg-gray-50/50 border border-gray-100 rounded-lg p-5 space-y-4">
              {/* Amount */}
              <div>
                <div className="text-xs font-medium text-gray-500 mb-2">Amount</div>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {fields.date ? format(fields.date, "MMM dd, yyyy") : "Select date"}
                      </Button>
                    </PopoverTrigger>
          ...
          {/* Contact Info - Only show if there's tenant information */}
          {(selectedUnit?.tenant || (!hasMultipleUnits && selectedListing?.tenant)) && (
            <div className="space-y-4">
              <div className="flex items-center">
              ...
              <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4">
                {(() => {
                  const tenant = selectedUnit?.tenant || selectedListing?.tenant;
