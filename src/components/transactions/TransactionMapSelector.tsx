...
export function TransactionMapSelector({ listings, selectedListingId, onListingSelect, onClose }: TransactionMapSelectorProps) {
  ...
  return (
    <div className="h-full w-full relative bg-black">
      ...
      <Button
        ...
        size="icon"
        onClick={onClose}
        className="absolute top-4 right-4 z-50 h-10 w-10 bg-black/50 hover:bg-black/70 text-white rounded-full"
      >
        <X className="h-5 w-5" />
      </Button>
      ...
      <div className="absolute top-4 left-4 z-50 bg-black/50 text-white px-4 py-2 rounded-lg">
        ...
        <p className="text-sm text-gray-300">Click on a property marker to select it</p>
      </div>
