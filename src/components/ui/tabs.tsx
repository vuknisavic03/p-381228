...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-100/60 p-1.5 text-muted-foreground w-full border border-gray-200/50",
      className
    )}
    {...props}
  />
